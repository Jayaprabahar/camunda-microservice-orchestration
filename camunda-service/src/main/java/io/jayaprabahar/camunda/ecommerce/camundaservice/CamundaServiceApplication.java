 ...
 *
 * <p>This Spring Boot application boots the Zeebe/Camunda client and deploys BPMN
 * workflow definitions and forms found on the classpath. It serves as the
 * central orchestrator for the example e-commerce checkout workflows in this
 * repository.
 */
